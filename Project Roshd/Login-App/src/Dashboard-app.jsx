      ...
      <div className="Main">
        ...
        >
          <a href="/" className="home-link">
            <img src="/images/home.png" alt="خانه" />
            خانه
          </a>
          <br />
          <a href="#">
        ...
        <div className="left">
              ...
              <div className="b121" onClick={handleExit}>
                ...
                {exitModal && (
                  ...
                  >
                    ...
                    >
                      <p style={{ fontFamily: "Dana, sans-serif" }}>
          ...
          <div className="b3">
            ...
            <div className="b32">
              ...
              <div className="b323">
                <span title="کاربران">
                  <img src="/people.png" alt="کاربران" />
                </span>
              </div>
            </div>
            <div className="b33">
              ...
              <div className="b333">
                <span title="وب سایت ها">
                  <img src="/world.png" alt="وب سایت ها" />
                </span>
              </div>
            </div>
          </div>
